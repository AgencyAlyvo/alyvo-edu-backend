...
/**
 * Endpoints publics de distribution des mises a jour Alyvo Edu (manifest + binaires S3).
 */
export default class SoftwareController {
  /**
   * Retourne le manifeste Tauri updater stocke sur S3.
   * Les parametres d'URL sont conserves pour compatibilite avec plugin-updater.
   */
